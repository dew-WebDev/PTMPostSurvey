...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F80101577972458" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F80101577972458" title="oEmbed Form">
<meta property="og:title" content="Post-event survey - BUYER" >
<meta property="og:url" content="http://www.jotform.me/form/80101577972458" >
<meta property="og:description" content="Please click the link to complete this form.">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<title>Checkform - BUYER</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.3968" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.3968" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.3968" />
...
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"update","qid":"2","text":"Update","type":"control_button"},null,null,null,null,null,null,null,null,{"name":"1Does","qid":"11","text":"1. Does your company expect to confirm any orders/ group to this seller over the next 6-12 months","type":"control_radio"},null,null,{"name":"actualGenerated","qid":"14","text":"Definitely “No”","type":"control_textbox"},{"name":"expectedTo15","qid":"15","text":"Probably “No” ","type":"control_textbox"},{"name":"clickTo16","qid":"16","text":"Post-event survey - BUYER","type":"control_text"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"update","qid":"2","text":"Update","type":"control_button"},null,null,null,null,null,null,null,null,{"name":"1Does","qid":"11","text":"1. Does your company expect to confirm any orders/ group to this seller over the next 6-12 months","type":"control_radio"},null,null,{"name":"actualGenerated","qid":"14","text":"Definitely “No”","type":"control_textbox"},{"name":"expectedTo15","qid":"15","text":"Probably “No” ","type":"control_textbox"},{"name":"clickTo16","qid":"16","text":"Post-event survey - BUYER","type":"control_text"}]);}, 20); 
</script>
</head>
<body>
<?php
	...
	$RatedSellerID = $_GET['RatedSellerID'];
			...
			if (($RatedSellerIDAnswer == $_GET['RatedSellerID']))
			{
				...
				$result = mysql_query("select Question from BuyerQuestion");
				$storeArray = Array();
					while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    						$storeArray[] =  $row['Question'];  
					}

				$buyer_rating = mysql_query("select * from BuyerRating");
        ...
        $answer4 = $answer_buyer_row['Ans4'];
			...
			<form class="jotform-form" action="update_buyer_answer1.php" method="post" name="form_80101577972458" id="80101577972458" accept-charset="utf-8">
  <input type="hidden" name="formID" value="80101577972458" />
<input type="hidden" name="BuyerID" value="<?php echo"$BuyerID" ?>">
  ...
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line form-line-column form-col-1 form-line-column-clear jf-required" data-type="control_radio" id="id_11">
        ...
        <div id="cid_11" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_11_0" name="q11_1Does" value="Definitely “Yes”" <?php if($answer1!= "") echo "checked"; ?> required="" />
              <label id="label_input_11_0" for="input_11_0"> <?php echo $storeArray[1]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_11_1" name="q11_1Does" value="Probably “Yes”" <?php if($answer2!= "") echo "checked"; ?> required="" />
              <label id="label_input_11_1" for="input_11_1"> <?php echo $storeArray[2]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
      ...
      <li class="form-line form-line-column form-col-2 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_15">
        ...
        <div id="cid_15" class="form-input-wide jf-required">
          <input type="text" id="input_15" name="q15_expectedTo15" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="<?php echo "$answer3"; ?>" placeholder=" " data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line form-line-column form-col-3 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_14">
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="80101577972458" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "80101577972458-80101577972458";
  </script>
			...
			?>
<form class="jotform-form" action="insert_buyer_answer1.php" method="post" name="form_80101577972458" id="80101577972458" accept-charset="utf-8">
  <input type="hidden" name="formID" value="80101577972458" />
  <input type="hidden" name="BuyerID" value="<?php echo"$BuyerID" ?>">
  <input type="hidden" name="RatedSellerID" value="<?php echo"$RatedSellerID" ?>">
  <div class="form-all">
    <ul class="form-section page-section">
        ...
        <div id="cid_11" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_11_0" name="q11_1Does" value="Definitely “Yes”" required="" />
              <label id="label_input_11_0" for="input_11_0"> <?php echo $storeArray[1]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_11_1" name="q11_1Does" value="Probably “Yes”" required="" />
              <label id="label_input_11_1" for="input_11_1"> <?php echo $storeArray[2]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
      ...
      <li class="form-line form-line-column form-col-2 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_15">
        ...
        <div id="cid_15" class="form-input-wide jf-required">
          <input type="text" id="input_15" name="q15_expectedTo15" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" placeholder=" " data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line form-line-column form-col-3 jf-required form-field-hidden" style="display:none;" data-type="control_textbox" id="id_14">
        <label class="form-label form-label-top" id="label_14" for="input_14">
