...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F73512175872459" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F73512175872459" title="oEmbed Form">
<meta property="og:title" content="Post-event survey - SELLER" >
<meta property="og:url" content="http://www.jotform.me/form/73512175872459" >
<meta property="og:description" content="Please click the link to complete this form.">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<title>Post-event survey - SELLER</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.3970" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.3970" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.3970" />
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/buttons/form-submit-button-simple_white.css?3.3.3970"/>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.3970" type="text/javascript"></script>
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"save","qid":"2","text":"Save","type":"control_button"},null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey -&nbsp;SELLER","type":"control_text"},{"name":"1To","qid":"17","text":"1. To what degree is this Buyer interested in your product?","type":"control_radio"},{"name":"typeA","qid":"18","text":"2. Is this Buyer your prospect business partner?","type":"control_radio"},null,{"name":"3Would","qid":"20","text":"3. Would you recommend PATA to host this buyer to future B2B events?","type":"control_radio"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"save","qid":"2","text":"Save","type":"control_button"},null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey -&nbsp;SELLER","type":"control_text"},{"name":"1To","qid":"17","text":"1. To what degree is this Buyer interested in your product?","type":"control_radio"},{"name":"typeA","qid":"18","text":"2. Is this Buyer your prospect business partner?","type":"control_radio"},null,{"name":"3Would","qid":"20","text":"3. Would you recommend PATA to host this buyer to future B2B events?","type":"control_radio"}]);}, 20); 
</script>
</head>
<body>
<?php
...
?>
        ...
        <div id="cid_20" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_20_0" name="q20_3Would" value="Yes" <?php if($answer7!= "") echo "checked"; ?> required="" />
              <label id="label_input_20_0" for="input_20_0"> <?php echo $storeArray[9]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_1" name="q20_3Would" value="No" <?php if($answer8!= "") echo "checked"; ?> required="" />
              <label id="label_input_20_1" for="input_20_1"> <?php echo $storeArray[10]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_2" name="q20_3Would" value="May be" <?php if($answer9!= "") echo "checked"; ?> required="" />
              <label id="label_input_20_2" for="input_20_2"> <?php echo $storeArray[11]; ?> </label>
            </span>
          </div>
        </div>
      </li>
  ...
  document.getElementById("si" + "mple" + "_spc").value = "73512175872459-73512175872459";
      ...
      ?>
 <form class="jotform-form" action="insert_seller_answer1.php" method="post" name="form_73512175872459" id="73512175872459" accept-charset="utf-8">
  <input type="hidden" name="formID" value="73512175872459" />
  <input type="hidden" name="SellerID" value="<?php echo"$SellerID" ?>">
  <input type="hidden" name="RatedBuyerID" value="<?php echo"$RatedBuyerID" ?>">
  <div class="form-all">
        ...
        <div id="cid_17" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_17_0" name="q17_1To" value="Extremely" required="" />
              <label id="label_input_17_0" for="input_17_0"> <?php echo $storeArray[1]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_17_1" name="q17_1To" value="Moderate" required="" />
              <label id="label_input_17_1" for="input_17_1"> <?php echo $storeArray[2]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_17_2" name="q17_1To" value="Slightly" required="" />
              <label id="label_input_17_2" for="input_17_2"> <?php echo $storeArray[3]; ?> </label>
            </span>
          </div>
        </div>
        ...
        <div id="cid_18" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_18_0" name="q18_typeA" value="Yes" required="" />
              <label id="label_input_18_0" for="input_18_0"> <?php echo $storeArray[5]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_18_1" name="q18_typeA" value="No" required="" />
              <label id="label_input_18_1" for="input_18_1"> <?php echo $storeArray[6]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_18_2" name="q18_typeA" value="May be" required="" />
              <label id="label_input_18_2" for="input_18_2"> <?php echo $storeArray[7]; ?> </label>
            </span>
          </div>
        </div>
        ...
        <div id="cid_20" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="3" data-component="radio">
            <span class="form-radio-item">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_20_0" name="q20_3Would" value="Yes" required="" />
              <label id="label_input_20_0" for="input_20_0"> <?php echo $storeArray[9]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_1" name="q20_3Would" value="No" required="" />
              <label id="label_input_20_1" for="input_20_1"> <?php echo $storeArray[10]; ?> </label>
            </span>
            <span class="form-radio-item">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_20_2" name="q20_3Would" value="May be" required="" />
              <label id="label_input_20_2" for="input_20_2"> <?php echo $storeArray[11]; ?> </label>
            </span>
          </div>
        </div>
