...
<title>90 Days Post Survey</title>
...
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"update","qid":"2","text":"Update","type":"control_button"},null,null,null,null,null,null,null,null,null,{"description":"","name":"input12","qid":"12","text":"","type":"control_radio"},null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey - BUYER","type":"control_text"},{"name":"clickTo","qid":"17","text":"1. Approximately, how many business leads did you expect to generate and how many were actually generated from PTM2017 participation?","type":"control_text"},{"name":"clickTo18","qid":"18","text":"2. Please indicated the estimated buying volume to this exhibitor as a result of your PTM2017 participation","type":"control_text"},{"description":"","name":"expectedTo19","qid":"19","subLabel":"US$","text":"Expected To Generate","type":"control_textbox"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"update","qid":"2","text":"Update","type":"control_button"},null,null,null,null,null,null,null,null,null,{"description":"","name":"input12","qid":"12","text":"","type":"control_radio"},null,null,null,{"name":"clickTo16","qid":"16","text":"Post-event survey - BUYER","type":"control_text"},{"name":"clickTo","qid":"17","text":"1. Approximately, how many business leads did you expect to generate and how many were actually generated from PTM2017 participation?","type":"control_text"},{"name":"clickTo18","qid":"18","text":"2. Please indicated the estimated buying volume to this exhibitor as a result of your PTM2017 participation","type":"control_text"},{"description":"","name":"expectedTo19","qid":"19","subLabel":"US$","text":"Expected To Generate","type":"control_textbox"}]);}, 20); 
</script>
...
<?php
							...
							$result = mysql_query("SELECT MAX(ID) AS max_page FROM BuyerAnswerAll1 where BuyerID='".$BuyerID."'");
       						$row = mysql_fetch_array($result);
							

							$Checkform = mysql_query("select * from BuyerAnswerAll1 where BuyerID='".$BuyerID."' and ID='".$row["max_page"]."'");
							...
							if (($CheckformAnswer != ""))
								{
									...
									$result = mysql_query("select Question from BuyerQuestionAll");
									$storeArray = Array();
										while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    										$storeArray[] =  $row['Question'];  
										}

										$buyer_rating = mysql_query("select * from BuyerRatingAll");
										$buyer_rating_row = mysql_fetch_array($buyer_rating) or die(mysql_error());
										$Title = $buyer_rating_row['Title'];
										$Round = $buyer_rating_row['Round'];

        									$result1 = mysql_query("SELECT MAX(ID) AS max_page FROM BuyerAnswerAll1 where BuyerID='".$BuyerID."'");
        									$row = mysql_fetch_array($result1);

											$answer_buyer = mysql_query("select * from BuyerAnswerAll1 where BuyerID='".$BuyerID."' and ID='".$row["max_page"]."'");
							...
							?>
<form class="jotform-form" action="update_buyer_answer_all1.php" method="post" name="form_80101407872449" id="80101407872449" accept-charset="utf-8">
  <input type="hidden" name="formID" value="80101407872449" />
    ...
    <ul class="form-section page-section">
     ...
     <li class="form-line" data-type="control_number" id="id_24">
        <label class="form-label form-label-left form-label-auto" id="label_24" for="input_24">
          <span style="font-weight: normal;"><?php echo $storeArray[1]; ?></span>
        </label>
      ...
      <li class="form-line" data-type="control_text" id="id_18">
        <div id="cid_18" class="form-input-wide">
          <div id="text_18" class="form-html" data-component="text">
            <strong><?php echo $storeArray[2]; ?></strong><span class="form-required">
            *
          </span>
          </div>
        </div>
        ...
        <div id="cid_12" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio validate[required]" id="input_12_0" name="q12_2Please" value="Under US$50,000" <?php if($answer2!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_0" for="input_12_0"> <?php echo $storeArray[3]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_12_1" name="q12_2Please" value="Between US$50,001- US$250,000" <?php if($answer3!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_1" for="input_12_1"> <?php echo $storeArray[4]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_12_2" name="q12_2Please" value="Between US$250,001- US$500,000" <?php if($answer4!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_2" for="input_12_2"> <?php echo $storeArray[5]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_12_3" name="q12_2Please" value="Between US$500,001 - US$ 750,000" <?php if($answer5!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_3" for="input_12_3"> <?php echo $storeArray[6]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_12_4" name="q12_2Please" value="Between US$750,001 US$1,000,000" <?php if($answer6!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_4" for="input_12_4"> <?php echo $storeArray[7]; ?> </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio validate[required]" id="input_12_5" name="q12_2Please" value="Above USD$1,000,000" <?php if($answer7!= "") echo "checked"; ?> required="" />
              <label id="label_input_12_5" for="input_12_5"> <?php echo $storeArray[8]; ?> </label>
            </span>
          </div>
        </div>
      </li>
      <li data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="text-align:center;" class="form-buttons-wrapper">
            ...
            <span></span>
            <input type="button" value="Cancel" onclick="self.close()" class="cancelbutton" style="text-decoration: none; padding:8px 18px;color: #777777;text-shadow:1px 1px 0px #ffffff;">
          </div>
        </div>
      </li>
      <li style="clear:both">
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="80101407872449" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "80101407872449-80101407872449";
  </script>
      ...
      ?>
<form class="jotform-form" action="insert_buyer_answer_all1.php" method="post" name="form_80101407872449" id="80101407872449" accept-charset="utf-8">
  <input type="hidden" name="formID" value="80101407872449" />
  <input type="hidden" name="BuyerID" value="<?php echo"$BuyerID" ?>">
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_text" id="id_18">
        <div id="cid_18" class="form-input-wide">
          <div id="text_18" class="form-html" data-component="text">
            <p><strong><?php echo $storeArray[2]; ?></strong><span class="form-required">
            *
          </span></p>
          </div>
        </div>
