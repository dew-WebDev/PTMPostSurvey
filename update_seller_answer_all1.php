...
require_once("query/connectivity.php");	
	...
	if(isset($_POST['IDAnswer']) ){
		...
		$sql1="UPDATE SellerAnswerAll1 SET Active='N' WHERE ID=".$_POST['IDAnswer']."";
		mysql_query($sql1);

		header("location:post_survey_seller_update_success.php");
		
		

	} else{
    
    	header("location:post_survey_seller_update_fail.php");
